        ...
        <footer className="relative bg-gradient-to-br from-slate-50 via-neutral-50 to-stone-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
            ...
            <div className="container mx-auto px-6 py-4">
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            ...
                            <motion.div
                                ...
                                className="flex items-center gap-3 text-brand-graytext dark:text-dark-text-secondary"
                            >
                                <FiMail size={18} className="text-brand-maroon dark:text-brand-yellow flex-shrink-0" />
                                <Link
                            ...
                            <motion.div
                                ...
                                className="flex items-center gap-3 text-brand-graytext dark:text-dark-text-secondary"
                            >
                                <FiGlobe size={18} className="text-brand-maroon dark:text-brand-yellow flex-shrink-0" />
                                <span>We provide products globally.</span>
                            </motion.div>

                            <motion.div
                                whileHover={{ x: 4 }}
                                className="flex items-start gap-3 text-brand-graytext dark:text-dark-text-secondary"
                            >
                                <FiMapPin size={18} className="text-brand-maroon dark:text-brand-yellow flex-shrink-0 mt-1" />
                                <Link
                ...
                <motion.div
                    ...
                    className="mt-8 pt-6 border-t border-brand-maroon/10 dark:border-gray-700/50 text-center"
                >

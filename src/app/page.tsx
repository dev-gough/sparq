        ...
        <div>
            <div className="relative h-[calc(100vh-66px)] overflow-x-hidden">
                ...
                <div className="flex items-center justify-center h-full transition-transform duration-200">
                    {showButtons && (
                        <div className="flex flex-col sm:flex-row sm:justify-center space-y-3 sm:space-y-0 sm:space-x-10 pt-8 mt-120 w-1/2 sm:w-full">
                            <Link href="/about" className="text-center bg-transparent border-white text-white hover:bg-slate-900 hover:text-white cursor-pointer font-black sm:text-xl py-3 px-5 border-3  rounded-4xl transition-colors drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8)]" onClick={handleLearnMore}>Learn More</Link>
                            <button onClick={openPopup} className="bg-transparent border-white text-white hover:bg-slate-900 hover:text-white cursor-pointer font-black sm:text-xl py-3 px-5 border-3  rounded-4xl transition-colors drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8)] ">Watch Video</button>
                            <button onClick={openWelcomePopup} className="bg-transparent border-white text-white hover:bg-slate-900 hover:text-white cursor-pointer font-black sm:text-xl py-3 px-5 border-3  rounded-4xl transition-colors drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8),0_1.2px_1.2px_rgba(0,0,0,0.8)]  ">Website Tour</button>
                        </div>
                    )}
                </div>
                {isPopupOpen && (

...
const accordionSections: AccordionSection[] = [
	...
	},
	{
		...
		content: (
			<div className="p-4 rounded-lg bg-gradient-to-r from-slate-50 to-neutral-50">
				<h3 className="font-bold text-brand-darkmaroon mb-4">Datasheet for SL200-2001</h3>
		...
		content: (
			<div className="p-4 rounded-lg bg-gradient-to-r from-slate-50 to-neutral-50">
				<div className="space-y-4">
					<div>
						<h3 className="font-bold text-brand-darkmaroon mb-2">Quick Install Guide for SL200-2001</h3>
						<div className="flex items-center gap-3">
							<div className="w-2 h-2 rounded-full bg-gradient-to-r from-brand-maroon to-brand-logo flex-shrink-0" />
					...
					<div>
						<h3 className="font-bold text-brand-darkmaroon mb-2">LED Indicator Guide for SL200-2001</h3>
						<div className="flex items-center gap-3">
							<div className="w-2 h-2 rounded-full bg-gradient-to-r from-brand-maroon to-brand-logo flex-shrink-0" />

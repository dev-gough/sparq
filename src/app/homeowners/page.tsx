        ...
        <div>
            ...
            <section id="whysparq" className="container mx-auto h-[calc(100vh-66px)] scroll-mt-[66px]">
                <header className="flex justify-between items-center p-4">
                    <h1 className="text-black font-bold uppercase text-4xl">
                ...
                {/* Subheading */}
                <div className="bg-brand-maroon rounded-full text-white text-center p-4 text-xl font-bold">
                ...
                {/* Footer */}
                <footer className="bg-brand-logo rounded-full text-white text-center p-4 text-lg">
                ...
                <div className="flex justify-evenly mt-8">
                    ...
                    <Link className="cursor-pointer border rounded-md p-4 text-xl bg-brand-maroon hover:bg-brand-darkmaroon text-white" href="/hassan_presentation.mp4">Watch Video</Link>
                </div>
            </section>
            ...
            {/* <div id="learnmore" className="bg-white container mx-auto py-8 px-4 sm:px-10 h-[calc(100vh-66px)] scroll-mt-[66px]">

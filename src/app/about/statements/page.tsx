...
export default function StatementsPage() {
    return (
        <div id="mission" className="flex flex-col items-center bg-gray-200">
            <div className="relative flex h-[calc(100vh-112px)] w-full bg-[url(/mission.png)] bg-no-repeat bg-cover justify-center">
                <Image src="/logo.png" alt="Sparq Logo" height={125} width={125} className="absolute top-2 right-2" />
                <div className="absolute top-1/3 bg-transparent rounded-lg mb-16 p-6 border-l-4 border-black w-full max-w-4/5">
            ...
            <div id="vision" className="relative flex h-[calc(100vh-114px)] w-full bg-[url(/vision.png)] bg-no-repeat bg-cover justify-center">
                <Image src="/logo.png" alt="Sparq Logo" height={125} width={125} className="absolute top-2 right-2" />
                <div className="absolute top-1/5 bg-transparent rounded-lg mb-16 p-6 border-l-4 border-white w-full max-w-4/5">
                    <div className="absolute -left-7 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 border-2 border-black">
            ...
            <div id="values" className="relative flex h-[calc(100vh-115px)] w-full bg-bottom bg-[url(/value.png)] bg-no-repeat bg-cover justify-center">
                <Image src="/logo.png" alt="Sparq Logo" height={125} width={125} className="absolute top-2 right-2" />
                <div className="absolute top-4/6 bg-transparent rounded-lg mb-16 p-6 border-l-4 border-white w-full max-w-4/5">
                    <div className="absolute -left-7 top-1/2 transform -translate-y-1/2 bg-white rounded-full p-2 border-2 border-black">

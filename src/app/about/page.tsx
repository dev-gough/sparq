...
const boardMembers: BoardMemberData[] = [
    ...
    },
    {
        ...
        title: 'Director since: December 31, 2021',
        blurb:
            'Dr. Goel is the CEO of Cistel Technology, an Information Technology company he founded in 1995 which has operations in Canada and the USA. A veteran technology executive and entrepreneur, he is also cofounder of CHiL Semiconductors and Sparq Systems. Dr. Goel has served on the Board of Directors of Enablence Technologies Inc (TSXV). He has also served on the Board of Directors of the Community Foundation of Ottawa, the Queensway Carleton Hospital Foundation, the Indo-Canada Ottawa Business Chamber, and as well as the Chair of the Queensway-Carleton Hospital Foundation. Dr. Goel obtained his PH degree from the University of Waterloo.',
    },
    {
...
const teamMembers: TeamMemberData[] = [
    {
        ...
        blurb: "Dr. Jain is the Founder and the CEO of SPARQ. He has considerable industrial experience in power electronics, working and consulting at Canadian Astronautics, Nortel Network, Astec, Intel, Freescale and GE. He founded CHiL Semiconductor, a digital power control chips company, which was acquired by International Rectifier (later merged with Infineon). Dr. Jain is a Fellow of the Royal Society of Canada, the Institute of Electrical and Electronic Engineers (IEEE), the Engineering Institute of Canada and the Canadian Academy of Engineering. He is the recipient of the 2021 IEEE Medal in Power Engineering, the 2017 IEEE Canada Electric Power Medal, the 2011 IEEE William E. Newell Power Electronics Award, and. 2004 Engineering Medal from the Ontario Professional Engineers. He holds over 100 patents. Dr. Jain obtained his PhD degree from the University of Toronto."
    },
    {

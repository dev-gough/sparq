...
/**
 * Technology page — React Server Component (no client JS for this route module).
 * Decorative background + static content only.
 */
...
const coreInnovations: TechFeature[] = [
  ...
  },
  {
    ...
    description:
      'Industry-first 4-in-1 microinverter design handling up to 2,000W total nominal capacity (suitable for 680W+ panels per PV input) with four independent PV MPPT input channels, reducing inverter count by 75% and significantly lowering installation and AC wiring costs.',
    benefits: [
      '75% fewer inverters needed',
      '2,000W total capacity',
      'Independent channel isolation',
      'Lowest per-watt cost',
    ],
    details:
      'Each Quad unit processes four independent PV panel inputs with independent MPPT per channel. Features wide MPPT voltage range with MC4 compatible receptacles. NEMA 6/IP-67 rated enclosure weighs only 4kg while delivering the highest power output per unit in the microinverter industry.',
  ...
  },
  {
    ...
    description:
      'Four completely independent Maximum Power Point Tracking controllers achieve 99.85% static and>99.8% dynamic MPPT efficiency, with each panel optimized individually for maximum energy harvest even under partial shading conditions and panel soiling.',
    benefits: [
      '99.85% static MPPT efficiency',
      'Independent optimization',
      'Fast dynamic response',
      'Shade tolerance',
    ],
    details:
      "Advanced real-time algorithms continuously track and optimize each panel's power output with dedicated MPPT controllers per channel. Wide voltage tracking range accommodates various panel types while maintaining peak performance. Eliminates power loss from series string effects and provides individual panel monitoring and diagnostics capabilities.",
...
const digitalEcosystem = [
  {
    name: 'SparqLinq',
    description:
      'Advanced energy management and monitoring system for real-time performance tracking.',
    features: [
  ...
  },
  {
    name: 'SparqVu',
    description:
      'Cloud-based monitoring platform providing comprehensive system insights and analytics.',
    features: [
  ...
  },
  {
    name: 'SparqSync',
    description:
      'Mobile application for Android and iOS providing on-the-go system monitoring and control.',
    features: [
      'Mobile monitoring',
      'System status',
      ...
      <div className="relative container mx-auto px-6 py-16">
        <div className="text-center mb-20">
          ...
          <p className="text-xl md:text-2xl text-brand-graytext dark:text-dark-text-secondary max-w-4xl mx-auto leading-relaxed mb-8">
            Breakthrough microinverter innovations that redefine solar energy conversion,
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-brand-graytext dark:text-dark-text-secondary max-w-3xl mx-auto">
              Fundamental technological breakthroughs that set our microinverters apart from
              conventional solar solutions.
            </p>
          </div>
        ...
        <div className="mb-24">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-brand-graytext dark:text-dark-text-secondary max-w-3xl mx-auto">
              Comprehensive monitoring and management solutions that provide complete system
              visibility and control.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {digitalEcosystem.map((product) => (
                  ...
                  <div className="space-y-2">
                    {product.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-brand-graytext dark:text-dark-text-secondary">
                          {feature}
                        </span>
                      </div>
                    ))}
        ...
        <div className="mb-16">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-brand-graytext dark:text-dark-text-secondary max-w-3xl mx-auto">
              Key specifications that demonstrate our technological leadership in microinverter
              design.
            </p>
          </div>
        ...
        <section className="container mx-auto px-6 pb-20 sm:py-20">
          <div className="text-center">
            ...
            <p className="text-lg text-brand-graytext dark:text-dark-text-secondary mb-12 max-w-2xl mx-auto">
              Discover how our innovative microinverter solutions can transform your solar energy
              system.
            </p>

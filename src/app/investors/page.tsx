...
export default function InvestorPage() {
    ...
    return (
        <div className="container mx-auto sm:px-4 pb-8 sm:mt-4">
            <div
                className="w-full sm:h-128 bg-cover bg-center sm:bg-top relative bg-[url(/tmp.jpg)] sm:rounded-xl">
                    ...
                    >
                        ...
                        <SwiperSlide>
                            <div className='px-0 sm:px-64 sm:pt-8'>
                                ...
                                {expanded && (
                                    <div>
                                        <p className='text-md sm:text-2xl pt-4'>is pleased to announce that on June 26, 2024 the Company received purchase orders for supplying over six-thousand Q2000 Quad Microinverters for the Indian market. </p>

...
export default function DesignPage() {
    return (
        <div className="container mx-auto py-8 px-4 sm:px-10 border border-brand-logo bg-neutral-100 rounded-xl">
            ...
            <p className="sm:text-2xl text-lg">Please use NREL&apos;s PVWatts calculator to estimate your energy production by entering your address at this link:<Link href="https://pvwatts.nrel.gov/" target="_blank"className="text-blue-400 hover:underline cursor-pointer ml-2">pvwatts.nrel.gov</Link> </p>

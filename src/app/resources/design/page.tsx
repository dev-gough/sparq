...
export default function DesignPage() {
    return (
        <div className="bg-white container mx-auto py-8 px-4 sm:px-10">
            <h1 className="text-5xl font-bold text-brand-maroon text-center sm:mb-16 mb-8 ">Design Your System</h1>
            ...
            <p className="flex flex-col sm:flex-row sm:text-2xl text-lg mt-4">Use the <IoIosInformationCircle className="hidden sm:flex mx-2 mt-1 text-blue-500" /> information bubbles to help modify the inputs to your needs.<strong className="ml-1"> Set the &quot;DC System Size (kW)&quot; field to 2.</strong></p>

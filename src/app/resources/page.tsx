                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
                    {videos.map((video, index) => (
                        <motion.div
                            ...
                            className="group"
                        >
                            <Card className="overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 group-hover:scale-105 cursor-pointer py-0">
                                <button
                                ...
                                >
                                    ...
                                    <CardContent className="p-6">
                                        <h3 className="text-xl font-bold text-brand-darkmaroon group-hover:text-brand-maroon transition-colors duration-300">
                                            {video.title}
                                        </h3>
                                    </CardContent>
                                </button>

...
For root page, figure out what the actual number is for. (in the three cards "Quad advantage...")

Think about a replacement for "Grid independence ready".

Quad 2 datasheets will change to reflect 18A. -> Majid will send me a new datasheet

Redo the SparqLinq installation video, similar to the Quad2 video.
Add to Quad2 & Quad3 pages once complete.
